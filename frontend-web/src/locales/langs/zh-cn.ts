...
>>>>>>> HEAD@{1}
  ...
  route: {
    ...
    manage_order: '订单管理',
    manage_comment: '评论管理',
    'manage_approval-store': '商家审批',
    'manage_approval-order': '订单审批',
    'manage_approval-comment': '评论审批',
    manage_approval: '审批看板',
    approval: '审批管理',
    approval_store: '商家审批',
    approval_order: '订单审批',
    approval_comment: '评论审批',
    vendor: '商家中心',
    vendor_register: '商家注册',
    vendor_item: '我的餐点',
    vendor_order: '订单管理',
    'multi-menu': '多级菜单',
...
>>>>>>> HEAD@{1}
      ...
      personalOverviewEmpty: '暂无可用数据',
      vendorItems: '餐点数量',
      vendorOrders: '订单（待办/总计）',
      adminPendingStores: '待审核商家',
      adminPendingComments: '待审核评论',
      customerOrders: '全部订单',
      customerPendingOrders: '待处理订单',
      vendorStoreMissing: '您还没有提交商家资料，请前往商家中心完成注册',
      vendorStorePending: '商家资料审核中，暂时无法管理订单',
      vendorStoreDisabled: '商家已停用，请联系管理员',
      userTotal: '用户总数',
      merchantTotal: '商家数量',
      orderTotal: '订单数量',
      amountTotal: '总金额',
