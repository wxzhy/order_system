...
>>>>>>> HEAD@{1}
  ...
  route: {
    ...
    manage_item: 'Item Manage',
    manage_order: 'Order Manage',
    manage_comment: 'Comment Manage',
    'manage_approval-store': 'Store Approval',
    'manage_approval-order': 'Order Approval',
    'manage_approval-comment': 'Comment Approval',
    manage_approval: 'Approval Dashboard',
...
>>>>>>> HEAD@{1}
      ...
      personalOverviewEmpty: 'No data available yet',
      vendorItems: 'Menu Items',
      vendorOrders: 'Orders (Pending/Total)',
      adminPendingStores: 'Stores Awaiting Review',
      adminPendingComments: 'Comments Awaiting Review',
      customerOrders: 'All Orders',
      customerPendingOrders: 'Pending Orders',
      vendorStoreMissing: 'You have not submitted store information yet. Visit the vendor center to start registration.',
      vendorStorePending: 'Your store information is under review. Management features are temporarily unavailable.',
      vendorStoreDisabled: 'Your store is disabled. Please contact an administrator.',
