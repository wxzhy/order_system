...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  approval_comment: () => import("@/views/approval/comment/index.vue"),
  approval: () => import("@/views/approval/index.vue"),
  approval_order: () => import("@/views/approval/order/index.vue"),
  approval_store: () => import("@/views/approval/store/index.vue"),
  ...
  "manage_approval-comment": () => import("@/views/manage/approval-comment/index.vue"),
  "manage_approval-order": () => import("@/views/manage/approval-order/index.vue"),
  "manage_approval-store": () => import("@/views/manage/approval-store/index.vue"),
  manage_approval: () => import("@/views/manage/approval/index.vue"),
  manage_comment: () => import("@/views/manage/comment/index.vue"),
  manage_item: () => import("@/views/manage/item/index.vue"),
  manage_menu: () => import("@/views/manage/menu/index.vue"),
  manage_order: () => import("@/views/manage/order/index.vue"),
  manage_role: () => import("@/views/manage/role/index.vue"),
  manage_store: () => import("@/views/manage/store/index.vue"),
  ...
  vendor: () => import("@/views/vendor/index.vue"),
  vendor_item: () => import("@/views/vendor/item/index.vue"),
  vendor_order: () => import("@/views/vendor/order/index.vue"),
  vendor_register: () => import("@/views/vendor/register/index.vue"),
};
