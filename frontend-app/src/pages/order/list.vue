                ...
                <view v-else class="order-list">
                    <view v-for="order in orders" :key="order.id" class="order-card">
                        <view class="card-header">
                            ...
                            <u-tag :text="getStatusConfig(order.state).text"
                                :type="getStatusConfig(order.state).tagClass" plain shape="circle" size="mini" />
                        </view>
                        ...
                        <view class="card-footer">
                            <u-button class="detail-button" type="primary" size="mini" shape="circle"
